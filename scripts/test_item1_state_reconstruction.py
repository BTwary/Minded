...
DB_DIR = tempfile.mkdtemp(prefix="aaos_item1_restart_")
DB_PATH = os.path.join(DB_DIR, "item1_restart_test.sqlite3")
...
writer_script = os.path.join(DB_DIR, "item1_restart_writer.py")
reader_script = os.path.join(DB_DIR, "item1_restart_reader.py")
